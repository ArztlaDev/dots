...
-- ======================================================================
-- GPU / hardware configuration — AUTO-GENERATED by modules/19-hardware-detect.sh
-- Do NOT edit between the >>> markers manually; the module rewrites this
-- block at install time based on the detected GPUs (AMD / NVIDIA / hybrid).
-- ======================================================================
-- >>> GPU_CONFIG_START >>>
